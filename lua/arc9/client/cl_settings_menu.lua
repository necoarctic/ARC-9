...
ARC9.SettingsTable = {
    ...
    },
    {
        ...
        { type = "bool", text = "settings.gameplay.fx_twoeyeaiming.title", desc = "settings.gameplay.fx_twoeyeaiming.desc", convar = "fx_twoeyeaiming" },
        { type = "slider", text = "settings.gameplay.fx_twoeyeaiming_max_alpha.title", desc = "settings.gameplay.fx_twoeyeaiming_max_alpha.desc", convar = "fx_twoeyeaiming_max_alpha", min = 0, max = 1, decimals = 2, parentconvar = "fx_twoeyeaiming" },
        { type = "slider", text = "settings.gameplay.fx_twoeyeaiming_min_alpha.title", desc = "settings.gameplay.fx_twoeyeaiming_min_alpha.desc", convar = "fx_twoeyeaiming_min_alpha", min = 0, max = 1, decimals = 2, parentconvar = "fx_twoeyeaiming" },
        { type = "slider", text = "settings.gameplay.fx_twoeyeaiming_start.title", desc = "settings.gameplay.fx_twoeyeaiming_start.desc", convar = "fx_twoeyeaiming_start", min = 0, max = 0.95, decimals = 2, parentconvar = "fx_twoeyeaiming" },
        { type = "bool", text = "settings.gameplay.fx_twoeyeaiming_depth_prepass.title", desc = "settings.gameplay.fx_twoeyeaiming_depth_prepass.desc", convar = "fx_twoeyeaiming_depth_prepass", parentconvar = "fx_twoeyeaiming" },
        { type = "slider", text = "settings.gameplay.fx_twoeyeaiming_reload_fade_time.title", desc = "settings.gameplay.fx_twoeyeaiming_reload_fade_time.desc", convar = "fx_twoeyeaiming_reload_fade_time", min = 0.01, max = 0.5, decimals = 2, parentconvar = "fx_twoeyeaiming" },
